      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        ...
        >
          ...
          <p className="text-lg text-foreground mb-10 max-w-lg leading-relaxed">
            RootEXP is an offline-first financial powerhouse. <strong className="text-primary">The living, swaying tree you see here is the exact dynamic model rendering inside the app's budget tracker.</strong> Developed by <strong className="text-primary">{process.env.DEVELOPER_NAME}</strong>. Secured on-device. Managed by you.
          </p>
