    ...
    <section className="py-24 px-6 relative overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto glass-base glass-card p-12 lg:p-20 rounded-[3rem] text-center border-primary/10 shadow-3xl shadow-primary/20">
        ...
        >
          ...
          <h2 className="text-4xl lg:text-6xl font-black mb-6 tracking-tight">Ready to start your <span className="text-primary italic">Financial Forest</span>?</h2>
          <p className="text-xl text-foreground mb-10 leading-relaxed max-w-2xl mx-auto font-medium">
            Join 50,000+ users who are already growing their wealth through the power of habit-forming gamification.
          </p>
